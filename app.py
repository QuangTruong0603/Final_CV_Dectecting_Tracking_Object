...
def main():
    ...
    conf_thres = st.sidebar.text_input("Class confidence threshold", 
        ...
        # Danh sách tất cả các tên class
    all_classes = ["person", "bicycle", "car", "motorcycle", "airplane", "bus", "train", "truck", "boat", "traffic light", "fire hydrant", "stop sign", "parking meter", "bench", "bird", "cat", "dog", "horse", "sheep", "cow", "elephant", "bear", "zebra", "giraffe", "backpack", "umbrella", "handbag", "tie", "suitcase", "frisbee", "skis", "snowboard"]

    # Hiển thị multiselect widget trong sidebar và lưu các lựa chọn của người dùng
    options = st.sidebar.multiselect("Objects", all_classes, [])

    # Tìm index của các tên class đã chọn
    selected_indices = [all_classes.index(option) for option in options]
    ...
    if input_source == "Video":
        ...
        if st.sidebar.button("Start Tracking"):
            ...
            detect(weights=weights, 
                   ...
                   device="cpu",
                    classes=selected_indices,nosave=nosave, 
